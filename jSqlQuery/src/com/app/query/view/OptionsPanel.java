...
import com.app.query.controller.ControllerApp;
...
public class OptionsPanel extends JPanel implements ActionListener {
	...
	public OptionsPanel(ControllerApp ctrl) {
		...
		lblTiempoEjecucion = new JLabel("Tiempo Máximo Ejecución: ");
		...
		btnGuardarConfiguracion = new JButton("Guardar configuración");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (comando.equals(EJECUTAR_SENTENCIA_SQL)) {
			...
			try {
				int confirmacion = JOptionPane.showConfirmDialog(this, "¿Desea guardar la configuración?",
						"Guardar configuración", JOptionPane.OK_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE);
				if (confirmacion == JOptionPane.OK_OPTION) {
					this.ctrl.guardarConfiguracion();
				}
			} catch (Exception ex) {
				JOptionPane.showMessageDialog(this, ex.getMessage(), "Guardar configuración",
						JOptionPane.ERROR_MESSAGE);
			}
		}
	}
